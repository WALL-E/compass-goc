#!/bin/bash
# Set up a compass service to join the compass-1 chain.
...
echo "Description=Hero service"       | sudo tee /etc/systemd/system/$NODE_MONIKER.service -a
...
echo "***********************"
echo "After you have updated the genesis file, start the compass service:"
